...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteAdapter = new FirestoreRecyclerAdapter<Note, NoteViewHolder>(allNotes) {
            ...
            protected void onBindViewHolder(@NonNull NoteViewHolder noteViewHolder, final int i, @NonNull final Note note) {
                ...
                noteViewHolder.noteDateModified.setText("Date Modified: "+ note.getDtModified());
                noteViewHolder.noteDateCreated.setText("Date Created: "+note.getDtCreated());
                ...
                noteViewHolder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("dtCreated",note.getDtCreated());
    ...
    public class NoteViewHolder extends RecyclerView.ViewHolder{
        TextView noteTitle,noteContent,noteDateCreated,noteDateModified;
        View view;
        CardView mCardView;
        ...
        public NoteViewHolder(@NonNull View itemView) {
            ...
            noteDateCreated = itemView.findViewById(R.id.datecreated);
            noteDateModified = itemView.findViewById(R.id.datemodified);
